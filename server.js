...
// ==============================
// 👤 USER PAGE (REMOVED MODAL, ADDED <a> TAGS)
// ==============================
...
/* Removed Modal Styles, keeping simple image hover */
img.img-thumb { cursor: pointer; transition: transform 0.2s ease; }
img.img-thumb:hover { transform: scale(1.05); }
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div style="margin-top:25px;">
        <h3 style="margin-bottom:10px;">Verification (Click to View)</h3>
        <div style="display:flex; gap:15px; flex-wrap:wrap; justify-content:center;">
          ...
          <div style="text-align:center;">
            ...
            <a href="${getImgSrc(u.selfie_image)}" target="_blank" style="text-decoration:none; display:block;">
              <img id="u-selfie" class="img-thumb" src="${getImgSrc(u.selfie_image)}" 
          ...
          <div style="text-align:center;">
            ...
            <a href="${getImgSrc(u.aadhar_front_image)}" target="_blank" style="text-decoration:none; display:block;">
              <img id="u-aadhar-front" class="img-thumb" src="${getImgSrc(u.aadhar_front_image)}" 
                   onerror="this.src='https://via.placeholder.com/150?text=No+Aadhar+F'; this.style.border='2px solid red'"
                   style="width:110px; height:110px; object-fit:cover; border-radius:10px; border:1px solid #ddd; background:#f5f5f5;" />
            </a>
          </div>

          <!-- AADHAR BACK (Wrapped in <a>) -->
          <div style="text-align:center;">
            ...
            <a href="${getImgSrc(u.aadhar_back_image)}" target="_blank" style="text-decoration:none; display:block;">
              <img id="u-aadhar-back" class="img-thumb" src="${getImgSrc(u.aadhar_back_image)}" 
    ...
    async function loadUserData(id) {
      try {
        ...
        if (json.success) {
          ...
          // ✅ UPDATED: Update Image AND Link
          const updateImage = (imgId, url, placeholder) => {
              const img = document.getElementById(imgId);
              const link = img.parentElement; // Get the <a> tag
              
              if (url && url.length > 10) {
                  img.src = url;
                  img.style.border = "1px solid #ddd";
                  link.href = url;     // Update link href
                  link.target = "_blank"; // Ensure it opens in new tab
              } else {
                  img.src = placeholder;
                  link.href = "#";    // Do nothing for placeholder
